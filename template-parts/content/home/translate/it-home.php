...
<h3><?php echo esc_attr(get_option('hero_salutation_it')); ?></h3>
<h1>
...
<h2>
    ...
    <?php if(checked(1, get_option('hero_job_it'), false)) :?>
        <?php echo get_option('title_job_it')?>
    <?php endif; ?>
</h2>

<p>
    <?php if(checked(1, get_option('hero_show_msg_it'), false)) :?>
...
<div>
    ...
    <?php if(checked(1, get_option('hero_add_btn_download'), false)) : ?>
        <a href="<?php echo get_option('import_cv_it'); ?>" class="btn" target="_blank">
